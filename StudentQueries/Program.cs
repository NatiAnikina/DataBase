...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(RRRRRContext context)
		{
		...
		static void FilterAndOrder(RRRRRContext context)
		{
		...
		static void Join(RRRRRContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(RRRRRContext context)
		{
			var result = from s in context.Students
		...
		{
			using (RRRRRContext c = new RRRRRContext())
			{
