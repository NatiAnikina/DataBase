...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(Mrrr context)
		{
		...
		static void FilterAndOrder(Mrrr context)
		{
		...
		static void GroupByFirstLetter(Mrrr context)
		{
			var result = from s in context.Students
